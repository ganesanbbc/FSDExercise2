...
public class WorkoutControllerTest {
	...
	public void testDefineWorkout() throws Exception {
		given(service.defineWorkout(Mockito.any(WorkOut.class))).willReturn(workout);
	...
	public void testGetWorkoutDetails() throws Exception {
		...
		Mockito.when(service.getWorkoutDetails((long) 1)).thenReturn(sampleWorkoutResponse);
	...
	public void testMultiHitsGetWorkoutDetails() throws Exception {
		...
		server.expect(ExpectedCount.manyTimes(), requestTo("/workout")).andExpect(method(HttpMethod.GET))
	     .andRespond(withSuccess("{ \"workoutId\" : \"1\", \"calBurntPerUnitTime\" : \"123\", \"title\" : \"123\",\"some_activity\" : \"null\"}", MediaType.APPLICATION_JSON));
	}
}
